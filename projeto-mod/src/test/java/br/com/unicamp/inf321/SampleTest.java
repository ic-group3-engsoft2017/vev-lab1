...
public class SampleTest {
  ...
  public void afterTest() throws Exception {
    ...
    pic.setAutofit(true);
    pic.writeAll(graph, "screenshots/" + SampleTest.class.getSimpleName() + "_graphstream_"
        + testName.getMethodName() + ".jpg");
  }

  @Test
  public void runSmokeTest() {
    Result result = new GraphWalkerTestBuilder().addModel(MODEL_PATH,
    ...
    Assertions.assertThat(result.getErrors())
        .as("Errors: [" + String.join(", ", result.getErrors()) + "]").isNullOrEmpty();
  }
